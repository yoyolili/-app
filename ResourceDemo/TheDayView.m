...
@implementation TheDayView

static NSString *identifier = @"day item";
...
- (void)loadContentFromNet
{
    ...
    [manager GET:[NSString stringWithFormat:@"http://www.wezeit.com/index.php?m=Home&c=Api&a=channelList&channel_id=30&page=%ld&time=1453253989&click_time=0&end_item=0&device_id=866819029961576&version=android_3.3.8",_pageIndex] parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
